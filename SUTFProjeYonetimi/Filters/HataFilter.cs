namespace SUTFProjeYonetimi.Filters
{
	public class HataFilter : System.Web.Mvc.FilterAttribute, System.Web.Mvc.IExceptionFilter
	{
		...
		public void OnException(System.Web.Mvc.ExceptionContext filterContext)
		{
			...
			//Helpers.MailHelper.SendMail(logText, "kemal.kolcuoglu@outlook.com.tr", "SUTF-Proje Yönetim Otomasyonu Hata", false);
			...
			filterContext.Result = new System.Web.Mvc.RedirectResult("/Panel/Hata"); // Son olarak kullanıcıyı kendi oluşturduğumuz hata sayfasına yönlendiririz.
		}
